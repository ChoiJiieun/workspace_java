...
public class StarCraftMain {
	...
	public static void main(String[] args) {
		...
		StarUnit highTemplar03 = highTemplar02;  // 자식에서 부모 객체로 형변환은 자동으로 됨.
