...
public class CollectiionEx {

	public static void main(String[] args) {
		// 1. top 100 가수 리스트를 오름차순으로 1줄에 5명씩 출력
		// -- top100 ArrayList의 가수이름이 중복되지 않게
		// ex) input arrayList, output arrayList
		//     배열을 전달 받아 가수의 이름으로 set에 담고 중복되지 않은 가수 arrayList를 리턴
		// 2. 가수 이름 입력시 해당 가수의 노래를 출력
		// -- 순서 정보 or 가수명을 입력받아 해당 가수의 노래만 출력
		...
		ArrayList<String> ex = new ArrayList<>(setSong(playList));
		
		HashSet<String> singer = new HashSet<>(ex);
		
		ArrayList<String> result = new ArrayList<>(singer);
	...
	public static ArrayList<String> setSong(ArrayList<String> arr) {
